                            ...
                            (function() {
                                ...
                                function initMap() {
                                            ...
                                            fetch('https://nominatim.openstreetmap.org/search?format=json&q=' + encodeURIComponent(ville + ', France'))
                                                ...
                                                .then(villeData => {
                                                    if (villeData && villeData.length > 0) {
                                                        ...
                                                        setMapAlert(mapId, 'warning', 'bi-geo-alt-fill', 'Adresse non géolocalisable : ' + address);
                                                    }
                                                })
                                                .catch(() => {
                                    ...
                                    .catch(error => {
                                        ...
                                        setMapAlert(mapId, 'danger', 'bi-exclamation-triangle', 'Service de carte temporairement indisponible');
                                    });
                                }
