...
Objectif : développer une application web pour l’entreprise **Vite & Gourmand** (Julie & José, traiteurs à Bordeaux) permettant de présenter les menus, gérer les commandes et disposer d’un back-office.
...
git clone [https://github.com/EtoileSombre/Vite_et_Gourmand.git](https://github.com/EtoileSombre/Vite_et_Gourmand.git)
