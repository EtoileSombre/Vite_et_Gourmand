...
class MongoLogger
{
     ...
     * 
     * @param array $data Données de la modération
     */
     ...
     * 
     * @param int|null $menuId ID du menu (null = tous les menus)
     * @param string|null $dateDebut Date de début (Y-m-d)
     * @param string|null $dateFin Date de fin (Y-m-d)
     * @return array
     */
