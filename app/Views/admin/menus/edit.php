                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select class="form-select" id="regime" name="regime">
                                    ...
                                    <option value="Végétarien" <?= ($menu['regime'] ?? '') === 'Végétarien' ? 'selected' : '' ?>>Végétarien</option>
                                    <option value="Végétalien" <?= ($menu['regime'] ?? '') === 'Végétalien' ? 'selected' : '' ?>>Végétalien</option>
                                    <option value="Sans gluten" <?= ($menu['regime'] ?? '') === 'Sans gluten' ? 'selected' : '' ?>>Sans gluten</option>
                                    <option value="Halal" <?= ($menu['regime'] ?? '') === 'Halal' ? 'selected' : '' ?>>Halal</option>
                                    <option value="Kasher" <?= ($menu['regime'] ?? '') === 'Kasher' ? 'selected' : '' ?>>Kasher</option>
                                </select>
                            </div>
