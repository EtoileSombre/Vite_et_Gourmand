...
<div class="container my-5">
    <div class="row">
        <div class="col-lg-10 mx-auto">
            ...
            <div class="card mb-4">
                <div class="card-body">
                    <h2 class="h4 mb-3">Article 2 - Prestations proposées</h2>
            ...
            <div class="card mb-4">
                <div class="card-body">
                    ...
                    <h3 class="h5 mt-4 mb-3">3.2. Délai de commande</h3>
            ...
            <div class="card mb-4">
                <div class="card-body">
                    <h2 class="h4 mb-3">Article 4 - Prix et Paiement</h2>
                    
                    <h3 class="h5 mt-3 mb-3">4.1. Prix</h3>
                    ...
                    <h3 class="h5 mt-4 mb-3">4.2. Réduction</h3>
                    ...
                    <h3 class="h5 mt-4 mb-3">4.3. Modalités de paiement</h3>
            ...
            <div class="card mb-4">
                <div class="card-body">
                    <h2 class="h4 mb-3">Article 5 - Livraison</h2>
                    
                    <h3 class="h5 mt-3 mb-3">5.1. Zone de livraison</h3>
                    <p>Vite & Gourmand livre dans un rayon de <strong>50 km autour de Bordeaux</strong>.</p>
                    
                    <h3 class="h5 mt-4 mb-3">5.2. Frais de livraison</h3>
            ...
            <div class="card mb-4">
                <div class="card-body">
                    <h2 class="h4 mb-3">Article 6 - Prêt de matériel</h2>
                    
                    <h3 class="h5 mt-3 mb-3">6.1. Conditions de prêt</h3>
            ...
            <div class="card mb-4">
                <div class="card-body">
                    <h2 class="h4 mb-3">Article 9 - Responsabilité</h2>
            ...
            <div class="card mb-4">
                <div class="card-body">
                    <h2 class="h4 mb-3">Article 10 - Droit de rétractation</h2>
                    <p>Conformément à l'article L221-28 du Code de la consommation, le droit de rétractation de 14 jours ne s'applique pas aux prestations de services d'hébergement, de transport, de restauration fournis à une date ou selon une périodicité déterminée.</p>
                    <p>Ainsi, <strong>aucun droit de rétractation</strong> ne peut être exercé pour les commandes de prestations traiteur avec date fixée.</p>
                </div>
            </div>

            <div class="card mb-4">
                <div class="card-body">
                    <h2 class="h4 mb-3">Article 11 - Protection des données personnelles</h2>
                    <p>Les données personnelles collectées font l'objet d'un traitement informatique conforme au RGPD.</p>
                    <p>Pour plus d'informations, consultez nos <a href="/mentions-legales">Mentions légales</a>.</p>
                </div>
            </div>
            ...
            <div class="card mb-4">
                <div class="card-body">
                    ...
                    <h3 class="h5 mt-4 mb-3">12.2. Droit applicable</h3>
