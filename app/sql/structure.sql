...
CREATE TABLE `commande` (
  ...
  `statut` enum('en_attente','acceptee','refusee','en_preparation','en_cours_livraison','livree','attente_retour_materiel','terminee','annulee') COLLATE utf8mb4_unicode_ci DEFAULT 'en_attente',
...
CREATE TABLE `suivi_commande` (
  ...
  `numero_commande` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL,
  `ancien_statut` enum('en_attente','acceptee','refusee','en_preparation','en_cours_livraison','livree','attente_retour_materiel','terminee','annulee') COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `nouveau_statut` enum('en_attente','acceptee','refusee','en_preparation','en_cours_livraison','livree','attente_retour_materiel','terminee','annulee') COLLATE utf8mb4_unicode_ci NOT NULL,
